...
(function(){
  ...
  var TIPS=[
   ...
   // ===== 公假上課／職災公傷 =====
   {emo:"🎓",q:'公司「要你去上」的課，<br>時間要<i>算工時或給公假</i>！',law:"勞工請假規則 §8"},
   {emo:"🎓",q:'依法令的公假，<br><i>工資照給</i>，不扣你錢！',law:"勞工請假規則 §8"},
   {emo:"🦺",q:'受傷治療休養，<br>給<i>公傷病假</i>（不是病假）！',law:"勞工請假規則 §6"},
   {emo:"⏳",q:'職災還沒認定？先請普通假，<br>認定後<i>改公傷追溯</i>！',law:"職災保險法 §88"},
   {emo:"🛡️",q:'職災<i>醫療期間</i>，<br>老闆<i>不能資遣你</i>！',law:"勞基法 §13"},
   {emo:"💰",q:'職災醫療不能上班，<br>雇主按<i>原領工資補償</i>！',law:"勞基法 §59"},
   {emo:"🩹",q:'醫療費、失能、死亡，<br>雇主<i>都要補償</i>！',law:"勞基法 §59"},
   {emo:"🔁",q:'康復後，雇主要<br><i>協助你復工或安置</i>！',law:"職災保險法 §67"},
   {emo:"🚨",q:'有立即危險，可<i>停工退避</i>，<br>不能因此處分你！',law:"職安法 §18"},
   {emo:"📣",q:'重大職災，雇主要<br><i>8 小時內通報</i>！',law:"職安法 §37"},
   {emo:"👔",q:'公務員執行職務受傷，<br>機關<i>應發慰問金</i>！',law:"公務人員保障法 §21"},
   {emo:"👔",q:'公務員受派受訓，<br>給<i>公假</i>不扣你的假！',law:"公務人員請假規則 §4"},
  ];
...
`;
  ...
  function boot(){
    ...
    if(!pKeep) setTimeout(close,5000);
  }
