...
(function(){
  ...
  var TIPS=[
   ...
   {emo:"💸",q:'告雇主討薪，<br>裁判費<i>大減免</i>！',law:"勞動事件法 §12"},
   {emo:"🆘",q:'沒錢打官司？<br>可聲請<i>訴訟救助</i>！',law:"勞動事件法 §14"},
   {emo:"🕊️",q:'告之前先<i>免費調解</i>，<br>又快又省！',law:"勞動事件法 §16"},
   {emo:"⏩",q:'勞動調解<br>原則<i>3 次內</i>解決！',law:"勞動事件法 · 調解"},
   {emo:"🏃",q:'勞動官司盡量<br><i>6 個月</i>內審完！',law:"勞動事件法 §32"},
   {emo:"🔙",q:'被違法開除？<br>可先<i>復職領薪</i>再打！',law:"勞動事件法 §49"},
   {emo:"👥",q:'一群人被坑，<br>工會可<i>一起提告</i>！',law:"勞動事件法 · 團體訴訟"},
   {emo:"🧊",q:'怕老闆脫產？<br>可<i>保全</i>＋擔保減免！',law:"勞動事件法 §47"},
   /* ===== 勞基法 ===== */
   {emo:"🏖️",q:'特休沒放完，<br>老闆要<i>折錢</i>給你！',law:"勞基法 §38"},
   {emo:"📅",q:'國定假日上班，<br>工資<i>加倍</i>給！',law:"勞基法 §39"},
   {emo:"😴",q:'每 7 天<br>至少休<i>1 天</i>！',law:"勞基法 §36"},
   ...
   {emo:"🧱",q:'老闆倒了欠薪？<br>有<i>墊償基金</i>！',law:"勞基法 §28"},
   {emo:"📦",q:'要資遣你，得<br><i>先預告</i>＋資遣費！',law:"勞基法 §16"},
   {emo:"📄",q:'離職可要<br><i>服務證明書</i>！',law:"勞基法 §19"},
   {emo:"🚑",q:'上班受傷，<br><i>原領工資</i>照給！',law:"勞基法 §59"},
   {emo:"🍼",q:'生產前後<br>有<i>8 週產假</i>！',law:"勞基法 §50"},
   {emo:"🤰",q:'懷孕可改做<br><i>較輕鬆</i>的工作！',law:"勞基法 §51"},
   {emo:"🙅",q:'有正當理由，<br>可<i>拒絕加班</i>！',law:"勞基法 §42"},
   {emo:"🛡️",q:'向老闆申訴，<br>他<i>不能報復</i>！',law:"勞基法 §74"},
   {emo:"💴",q:'薪水不能低於<br><i>基本工資</i>！',law:"勞基法 §21"},
   {emo:"🌪️",q:'天災被叫上班，<br>工資<i>加倍</i>＋補假！',law:"勞基法 §40"},
   {emo:"✍️",q:'工作規則<br>要<i>公開揭示</i>！',law:"勞基法 §70"},
   {emo:"📊",q:'加班費、資遣費<br>看<i>平均工資</i>算！',law:"勞基法 §2"},
   /* ===== 勞基法施行細則 ===== */
