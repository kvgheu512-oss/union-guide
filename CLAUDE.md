...
最近 commits：
  f421950 連署已達30人門檻，首頁用語從「籌備中·招募發起人」改成「連署達標·籌備成立大會中」，連署進度改顯示30/30已達標，連署人數與說明文字同步更新
  8cbffa4 自動更新 CLAUDE.md 最近進度（Stop hook）
  6d175a3 修正首頁找不到電子入會申請書的真正原因：電子版按鈕原本被寫死只在「正式成立」階段的彈窗才會出現，但網站現在是「籌備中」階段，籌備中按的紅色「我想連署／加入籌備」開的是另一個彈窗，裡面根本沒有這個選項；現在籌備中的彈窗也加上「線上填寫電子入會申請書」連結，同時移除多餘的連結未設定阻擋提示
  2a5bf6d 自動更新 CLAUDE.md 最近進度（Stop hook）
  7ef6e3d 章程「④入會申請書範本」加上電子版入口說明與按鈕，連到join-form.html(線上電子簽名入會申請)，紙本/電子雙軌互相看得到
<!-- AUTO:END -->
