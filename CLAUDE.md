...
最近 commits：
  d42ac5f 新增章程正式版Word與PDF下載檔（乾淨排版，仿北榮章程格式：標題置中、條文粗體、附註置頂），取代已過時的舊版對照北榮標註檔案（內容為25條的早期草案，與現行43條章程嚴重不符） 版本 2026070407
  6a8b488 自動更新 CLAUDE.md 最近進度（Stop hook）
  c555b7e §3組織區域明確納入台南分院等所屬分院：因應工會法第六條之一修正草案（廠場獨立性認定）之潛在爭議，明確涵蓋範圍避免日後對組織區域產生疑義；確認30人連署門檻計入分院人員 版本 2026070406
  d5bc6cb 自動更新 CLAUDE.md 最近進度（Stop hook）
  76f6a7e 修正附錄與主章程間之矛盾：附錄①②誤留「強制入會」用語與錯誤法條引用（工會法現行為自由入會，非強制，第七條實為自由退會規定非強制入會依據）、附錄①殘留16歲限制未隨主章程同步移除；並將§23特別決議清單之「除名」擴充為「停權及除名」，比照北榮章程使停權比照除名門檻辦理，避免多數決濫用停權架空正當程序保護 版本 2026070405
<!-- AUTO:END -->
