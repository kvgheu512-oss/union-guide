...
最近 commits：
  ebbb508 公文文號預設值發布到 public.json：正式字別「高總工」、籌備期字別「高總籌工」、民國年115、兩序列流水號起始1——全站新裝置免設定即可取號；並修正 wenhao.html 未監聽 public.json 載入完成事件、全新裝置第一眼顯示（字別）的時間差問題
  31e5963 自動更新 CLAUDE.md 最近進度（Stop hook）
