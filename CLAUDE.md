...
最近 commits：
  3621172 成立大會手冊網頁版字級行距對齊北榮原稿：內文18.5px（≈14點）行距1.8、表格16px（≈12點）、章節標題24px（≈18點），字體維持標楷體優先
  1877235 自動更新 CLAUDE.md 最近進度（Stop hook）
  81fde2d 成立大會手冊改依北榮工會正式「大會手冊」26頁結構全面重製：封面、目錄、大會流程（時間14:00起）、籌備委員名單分工表、籌備期間工作報告、收支報告、五案討論提案、臨時動議、第一屆理監事選舉（含空白選舉公報）、附件一至六（收支表、章程草案47條、工作計畫、兩年度預算、會籍管理辦法15條、入會費及經常會費減免辦法9條）——北榮專屬資料全數挖空或換成本會已公布資料，附件標註「草案提請審議」不冒充已通過
  aeff4aa 自動更新 CLAUDE.md 最近進度（Stop hook）
  bf141e5 公文列印稿版面改依「政府文書格式參考規範」：A4邊界2.5cm、中文標楷體/英數Times New Roman、機關全銜20點（行距36點）置中、受文者與主旨說明16點（行距28點）、發文資訊與正副本12點（行距15點）、檔號保存年限移至左上、密等欄改為官方全稱「密等及解密條件或保密期限」、主旨說明改3字懸掛縮排、署名靠左——產出格式對齊筆硯（文書編輯共通服務平臺）標準
<!-- AUTO:END -->
