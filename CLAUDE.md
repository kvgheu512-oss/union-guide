...
最近 commits：
  4d9f5cb 幹部功能表頂端加入首頁模式切換卡片 版本 2026062706
  ea176db 工會小幫手：「不方便露面」說明加入隱私保護承諾與關鍵限制 版本 2026062705
  cfd22cf 首頁雙模式：籌備中↔正式成立一鍵切換 版本 2026062704
  31100e9 工會小幫手：「找工會撐腰」前加入三步意願確認流程 版本 2026062703
  a3cabf2 update-notes.py：更新後自動 commit+push，避免未提交警告
<!-- AUTO:END -->
