...
最近 commits：
  ...
  51f6f77 修正§27錯誤法條引用並移除工會法未授權之流會降門檻機制：改為重新召集仍須符合原門檻，並強化委託出席（工會法§27第2項，理事會主動協助會員完成委託手續）作為防杯葛工具；同時修正§28理監事罷免陳述意見機會之引用，避免過度擴張解釋工會法§26（該條僅明定會員停權除名之陳述意見規定） 版本 2026070401
  bf8399c 自動更新 CLAUDE.md 最近進度（Stop hook）
<!-- AUTO:END -->
